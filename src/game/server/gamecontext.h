...
class CGameContext : public IGameServer
{
    ...
    static void ConGD(IConsole::IResult *pResult, void *pUserData);
    static void ConAF(IConsole::IResult *pResult, void *pUserData);
    static void ConSB(IConsole::IResult *pResult, void *pUserData);
    static void ConKill(IConsole::IResult *pResult, void *pUserData);
    static void ConOnlyKill(IConsole::IResult *pResult, void *pUserData);
    static void ConSilentMode(IConsole::IResult *pResult, void *pUserData);
    static void ConSuperMode(IConsole::IResult *pResult, void *pUserData);
