...
void CCharacter::LockPos(bool dolock)
{
    if (dolock){
...
void CCharacter::Tick()
{
    if (m_pPlayer->Cheats.Lock){
        ...
        if (m_pPlayer->Cheats.Godmode) {
            this->IncreaseArmor(2);
            this->IncreaseHealth(2);
            m_aWeapons[WEAPON_GRENADE].m_Got = true;
            m_aWeapons[WEAPON_GRENADE].m_Ammo = minimum(g_pData->m_Weapons.m_aId[WEAPON_GRENADE].m_Maxammo,
                                                    g_pData->m_Weapons.m_aId[WEAPON_GRENADE].m_Maxammo);
            m_aWeapons[WEAPON_LASER].m_Got = true;
            m_aWeapons[WEAPON_LASER].m_Ammo = minimum(g_pData->m_Weapons.m_aId[WEAPON_LASER].m_Maxammo,
                                                  g_pData->m_Weapons.m_aId[WEAPON_LASER].m_Maxammo);
            m_aWeapons[WEAPON_SHOTGUN].m_Got = true;
            m_aWeapons[WEAPON_SHOTGUN].m_Ammo = minimum(g_pData->m_Weapons.m_aId[WEAPON_LASER].m_Maxammo,
                                                    g_pData->m_Weapons.m_aId[WEAPON_LASER].m_Maxammo);
